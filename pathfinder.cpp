...
void aStarSearch(Worlds *world, Pair src, Pair dest)
{
    ...
    if (isUnBlocked(world, src.first, src.second) == false
        || isUnBlocked(world, dest.first, dest.second)
               == false) {
